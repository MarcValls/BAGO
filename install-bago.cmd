...
:: --- Download ---
set "ZIP_URL=https://github.com/MarcValls/BAGO/releases/download/v3.4.1/BAGO-3.4.1.zip"
...
if exist "%PS_PROFILE%" (
    ...
    if !errorlevel! neq 0 (
        echo. >> "%PS_PROFILE%"
        echo # BAGO Framework v3.4.1 >> "%PS_PROFILE%"
...
echo.
echo  ===========================================
echo   BAGO v3.4.1 instalado correctamente
echo  ===========================================
echo.
