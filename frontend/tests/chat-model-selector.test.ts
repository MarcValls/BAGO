...
describe('chat model selector', () => {
  it('lists all router models (including unavailable) when no active-model filter exists', () => {
  ...
  it('keeps every provider visible (available and unavailable) when a local active-model filter exists', () => {
