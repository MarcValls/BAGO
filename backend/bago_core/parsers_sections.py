...
def add_ops_parsers(sub: argparse._SubParsersAction) -> None:
    ...
    agent_list.add_argument("--catalog", default=argparse.SUPPRESS, help="Ruta del catalogo externo de agentes")
    agent_list.add_argument("--json", action="store_true", help="Salida JSON")
    ...
    agent_run.add_argument("--catalog", default=argparse.SUPPRESS, help="Ruta del catalogo externo de agentes")
    agent_run.add_argument("agent_id")
    agent_kill = agent_sub.add_parser("kill", help="Desactiva un agente")
    agent_run.add_argument("--mode", default="run", choices=["run", "chat", "describe"], help="Modo de ejecucion del agente")
    agent_run.add_argument("--provider", default="", help="Proveedor LLM externo")
    agent_run.add_argument("--model", default="", help="Modelo LLM externo")
    agent_run.add_argument("--use-bago-provider", action="store_true", help="Usar proveedor configurado de BAGO")
    agent_run.add_argument("--base-url", default="", help="URL base del provider")
    agent_run.add_argument("--api-key", default="", help="API key del provider")
    agent_run.add_argument("--temperature", type=float, default=None, help="Temperatura de muestreo")
    agent_run.add_argument("--max-tokens", type=int, default=None, help="Maximo de tokens de salida")
    agent_run.add_argument("--no-dry-run", action="store_true", help="Llamar realmente al LLM")
    agent_run.add_argument("task_words", nargs="*", default=[], help="Palabras de la tarea")

    agent_plan = agent_sub.add_parser("plan", help="Selecciona agentes y guarda un plan JSON sin ejecutarlos")
    agent_plan.add_argument("--root", default=argparse.SUPPRESS, help="Raiz del proyecto (default: cwd)")
    agent_plan.add_argument("--catalog", default=argparse.SUPPRESS, help="Ruta del catalogo externo de agentes")
    agent_plan.add_argument("--provider", default="", help="Proveedor LLM para seleccion estructurada")
    agent_plan.add_argument("--model", default="", help="Modelo para seleccion estructurada")
    agent_plan.add_argument("--use-bago-provider", action="store_true", help="Usar proveedor configurado de BAGO")
    agent_plan.add_argument("--base-url", default="", help="URL base del provider")
    agent_plan.add_argument("--api-key", default="", help="API key del provider")
    agent_plan.add_argument("--temperature", type=float, default=None, help="Temperatura de muestreo")
    agent_plan.add_argument("--max-tokens", type=int, default=None, help="Maximo de tokens de salida")
    agent_plan.add_argument("--no-dry-run", action="store_true", help="Usar el LLM para seleccionar agentes")
    agent_plan.add_argument("task_words", nargs="*", default=[], help="Palabras de la tarea")

    agent_describe = agent_sub.add_parser("describe", help="Muestra la definicion de un agente")
    agent_describe.add_argument("--root", default=argparse.SUPPRESS, help="Raiz del proyecto (default: cwd)")
    agent_describe.add_argument("--catalog", default=argparse.SUPPRESS, help="Ruta del catalogo externo de agentes")
    agent_describe.add_argument("agent_id")
