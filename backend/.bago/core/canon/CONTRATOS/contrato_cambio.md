...
> La referencia vigente para cambios, invalidación y trazabilidad vive en `docs/contracts/bago_v4_engineering_contract.md` y `docs/contracts/bago_v4_governance_contract.md`.
