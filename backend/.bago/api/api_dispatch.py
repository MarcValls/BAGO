...
ROUTE_META: tuple = (
    ...
    ("POST", "/project/patch",       "handlers_project_patch", "handle_apply"),
    ("POST", "/project/patch/rollback", "handlers_project_patch", "handle_rollback"),
    ("POST", "/workspace/persist",   "handlers_workspace",  "handle_persist"),
    ("POST", "/context/attach",      "handlers_context_attach", "handle"),
    ...
    ("POST", "/process/execute",   "handlers_process",   "handle_execute"),
    ...
    ("POST", "/release/apply",       "handlers_release",    "handle_apply"),
      ("POST", "/install/apply",       "handlers_install",    "handle_apply"),
      ("POST", "/install/rollback",    "handlers_install",    "handle_rollback"),
      ("POST", "/install/source-update", "handlers_install", "handle_source_update"),
    ("POST", "/install/uninstall", "handlers_install", "handle_uninstall"),
    ("POST", "/manager/settings/write", "handlers_manager_settings", "handle_write"),
    ("POST", "/release/jobs/verify-signature", "handlers_release_jobs", "handle_verify_signature"),
    ("POST", "/release/jobs/stage-bundle", "handlers_release_jobs", "handle_stage_bundle"),
    ("POST", "/release/jobs/download-asset", "handlers_release_jobs", "handle_download_asset"),
    ("POST", "/release/jobs/persist", "handlers_release_jobs", "handle_persist_job"),
    ("POST", "/release/jobs/append-log", "handlers_release_jobs", "handle_append_log"),
    ("POST", "/desktop/viewer-log", "handlers_desktop", "handle_viewer_log"),
    ("POST", "/release/jobs/archive", "handlers_release_jobs", "handle_archive_job"),
