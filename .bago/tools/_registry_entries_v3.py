"""_registry_entries_v3.py — Subset of BAGO tool registry."""
...
_ENTRIES: dict[str, ToolEntry] = {
    ...
    "sprite-studio": ToolEntry(
        cmd="sprite-studio", module="visual_studio",
        description="[DEPRECATED] Generador de sprites BIANCA. Usa: bago visual-studio sprite",
        preflight=[PreflightCheck("file", str(TOOLS_DIR / "visual_studio.py"))],
        deprecated=True, see_also="bago visual-studio sprite",
    ),
    "image-studio": ToolEntry(
        cmd="image-studio", module="visual_studio",
        description="[DEPRECATED] Generador de assets visuales. Usa: bago visual-studio image",
        preflight=[PreflightCheck("file", str(TOOLS_DIR / "visual_studio.py"))],
        deprecated=True, see_also="bago visual-studio image",
    ),
    "visual-studio": ToolEntry(
        cmd="visual-studio", module="visual_studio",
        description="Dominio unificado de assets visuales BAGO: sprite + image",
        preflight=[PreflightCheck("file", str(TOOLS_DIR / "visual_studio.py"))],
    ),
    "infra-scan": ToolEntry(
        cmd="infra-scan", module="bago_infra_scan",
        description="Escaneo automatico de servicios de modelos (Ollama/Copilot/Codex) por IP:puerto",
        preflight=[PreflightCheck("file", str(TOOLS_DIR / "bago_infra_scan.py"))],
    ),
    "instance": ToolEntry(
        cmd="instance", module="bago_instance_manager",
        description="Gestión de múltiples instalaciones BAGO (register/create/switch)",
        preflight=[PreflightCheck("file", str(TOOLS_DIR / "bago_instance_manager.py"))],
    ),
    "list": ToolEntry(
        cmd="list", module="bago_instance_manager",
        description="Lista instalaciones BAGO detectadas y registradas",
        preflight=[PreflightCheck("file", str(TOOLS_DIR / "bago_instance_manager.py"))],
    ),
    "launch": ToolEntry(
