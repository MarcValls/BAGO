#!/usr/bin/env python3
"""
repl.py — BAGO 4.0 Chat REPL (Rediseño Completo)
...
class BagoREPL:
    ...
    def _print_banner(self) -> None:
        print(R.banner())
        print()
        print(R.info("Bienvenido a BAGO 4.0. Escribe /help para ver comandos o /menu para navegar."))
