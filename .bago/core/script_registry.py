#!/usr/bin/env python3
"""
script_registry.py — BAGO 4.0 Script Registry
...
class ScriptRegistry:
    ...
    def __init__(self, repo_root: str | Path | None = None) -> None:
        ...
        self._scripts: dict[str, ScriptSpec] = {
            ...
            "runtime.cpp_runtime_host_test": ScriptSpec(
                id="runtime.cpp_runtime_host_test",
                battery="runtime",
                description="Smoke test del host de runtime C++.",
                path="bago_core/cpp_runtime_host.py",
                keywords=("cpp", "runtime", "host"),
                fixed_args=("--test",),
            ),
            "runtime.cpp_local_adapter_test": ScriptSpec(
                id="runtime.cpp_local_adapter_test",
                battery="runtime",
                description="Smoke test del adapter cpp-local.",
                path=".bago/providers/cpp_local.py",
                keywords=("cpp", "adapter", "local"),
                fixed_args=("--test",),
            ),
