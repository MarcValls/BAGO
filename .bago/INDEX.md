# BAGO — Índice operativo

Este índice deja la raíz de `.bago/` para arranque, manifiestos y runtime. La
documentación histórica queda reunida en un catálogo plano para no mezclarse con
los contratos activos.

## Entrada activa

- `BOOTSTRAP.md` — protocolo de arranque para agentes.
- `AGENT_START.md` — contexto inicial para agentes.
- `START_AGENT.md` — arranque corto.
- `README.md` — descripción técnica de la capa BAGO.
- `QUICKSTART.md` — guía rápida interna.
- `pack.json` — manifiesto canónico del pack.
- `tools.manifest.json` — manifiesto de herramientas.
- `ideas_catalog.json` — catálogo de ideas.
- `../web_tools/` — herramientas HTML estáticas del framework.

## Catálogo histórico

- `archive/CLI_*` — documentación CLI v3 histórica.
- `archive/TABLET_*` y `archive/README_TABLET_START_HERE.md` — despliegues tablet.
- `archive/*FACTORY*` — documentación de factories de agentes y roles.
- `archive/DEMO_*`, `archive/*VERIFICATION*`, `archive/GUIDE_HOW_TO_USE.md` — demos, verificaciones y guías antiguas.
- `archive/INDEX_FACTORY_DEMO.md` — índice histórico anterior.# 🎭 BAGO Integration & Demo — Complete Overview
