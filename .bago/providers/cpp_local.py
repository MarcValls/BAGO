...
cpp_local.py â€” BAGO 4.1.5 C++ Local Runtime Adapter

Adapter para un runtime local externo escrito en C++.
Fase 1: define el contrato HTTP/JSON mÃ­nimo para salud, modelos y chat.
Python conserva la sesiÃ³n; C++ actÃºa como motor local intercambiable.
"""
