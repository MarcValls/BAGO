...
Registro canónico de lecciones aprendidas del BAGO local.
...
Cada entrada debe ser suficientemente concreta para volver a aplicarla sin
...
# CONTENIDO FUSIONADO DESDE RAÍZ (learned_lessons.md)
