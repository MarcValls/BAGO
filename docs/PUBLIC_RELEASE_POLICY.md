...
Current release claims must point at the 4.6.3 bundle:

- ZIP: `release/v4/bago-v4.6.3.zip`
- ZIP checksum: `release/v4/bago-v4.6.3.zip.sha256`
- Installer: `dist/BAGO-Installation-Manager-4.6.3-win-x64.exe`
- Audit bundle: `release/v4/bago-audit-v4.6.3.zip`
