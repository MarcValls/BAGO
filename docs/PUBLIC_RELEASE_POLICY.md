...
Current release claims must point at the current 4.7 bundle:

- ZIP: `release/v4/bago-v4.7.0.zip`
- ZIP checksum: `release/v4/bago-v4.7.0.zip.sha256`
- Installer: `dist/BAGO-Installation-Manager-4.7.0-win-x64.exe`
- Audit bundle: `release/v4/bago-audit-v4.7.0.zip`
