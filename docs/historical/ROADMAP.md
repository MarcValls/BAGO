# Archived BAGO v4.3.0 Distribution Roadmap

> Archived planning note. Current source of truth lives in `../../README.md`, `../MVP.md`, `../MODULES.md`, `../CLAIMS.md`, `../SECURITY.md`, `../TESTING.md`, and `../RELEASE_CHECKLIST.md`.
...
- `../MVP.md` freezes the stable MVP.
- `../MODULES.md` marks working, partial, experimental, planned, and deprecated surfaces.
- `../CLAIMS.md` maps public claims to proof.
- `../NODE_CONTROL_SPEC.md` freezes the connector/node contract.
- `NODE_CONTROL_BACKLOG.md` turns that contract into implementation phases.
- `../CENTRALIZATION_CONTRACT.md` freezes what is centralized, local, and forbidden.
- `CENTRALIZATION_IMPLEMENTATION_PLAN.md` turns the centralization contract into phases.
- `../AUTONOMOUS_EXECUTION_CONTRACT.md` freezes headless and interactive execution rules.
- `AUTONOMOUS_EXECUTION_PLAN.md` turns those rules into phases and validation gates.
- `../SUPPORT_MATRIX.md` declares operating-system support.
