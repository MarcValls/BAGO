...
- **Session ID:** `6ef8cc6c-170`
- **Generado en:** `C:\Users\AMTEC_Terminal_1º\BAGO\docs\evidence\release_4_1_5`
...
Resultados para 'conocimiento recuperable':
  • BAGO v4 debe convertir una conversacion util en conocimiento recuperable y en un artefacto verificab... (sesión: 6ef8cc6c-170)
```
