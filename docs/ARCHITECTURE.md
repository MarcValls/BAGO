...
BAGO v4 is a session-first control plane. The stable product path is Python CLI, local API, optional React UI, contracts, and evidence. C++ stays experimental and cannot block distribution.
