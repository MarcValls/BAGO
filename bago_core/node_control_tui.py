...
def _print_menu() -> None:
    print("1. Estado · ver resumen operativo")
    print("2. Piezas · listar piezas y funciones")
    print("3. Conectores · revisar enlaces pieza/instalación")
    print("4. Matriz · comparar compatibilidad")
    print("5. Validar · ejecutar validación")
    print("6. Exportar · guardar registry")
    print("7. Conectar · unir instalación y pieza")
    print("8. Desconectar · separar instalación y pieza")
    print("9. Cambiar modo · ajustar modo del conector")
    print("0. Salir")
