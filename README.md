...
> Version: 3.5.0 · 179 CLI commands · 144 public commands
...
Documentación:
[`INSTALL.md`](INSTALL.md) · [`QUICKSTART.md`](QUICKSTART.md) · [`docs/USER_MANUAL.md`](docs/USER_MANUAL.md) · [`docs/DEVELOPERS.md`](docs/DEVELOPERS.md) · [`docs/SPONSORS.md`](docs/SPONSORS.md) · [`docs/INSTALL_DEEP.md`](docs/INSTALL_DEEP.md)
...
**Requirements:** Python 3.10+ · Git · PowerShell en Windows

Usa los comandos de la sección inicial. La ruta por defecto es `C:\Program Files\BAGO` en Windows y `~/.local/share/bago` en macOS/Linux. Puedes cambiarla con `-TargetRoot` en Windows o `BAGO_TARGET_ROOT` en macOS/Linux.
