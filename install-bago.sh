#!/usr/bin/env bash
# BAGO One-Click Installer v3.4.1
# Uso:
#   curl -fsSL https://github.com/MarcValls/BAGO/releases/download/v3.4.1/install-bago.sh | bash
#   O descarga install-bago.sh, chmod +x install-bago.sh, ./install-bago.sh

set -euo pipefail

REPO="https://github.com/MarcValls/BAGO"
ZIP_URL="$REPO/releases/download/v3.4.1/BAGO-3.4.1.zip"
...
echo ""
echo "==========================================="
echo "  BAGO Framework v3.4.1 — Instalador Rapido"
echo "==========================================="
echo ""
...
if [[ -f "$SHELL_RC" ]] && grep -q "alias bago=" "$SHELL_RC" 2>/dev/null; then
    ...
    echo "" >> "$SHELL_RC"
    echo "# BAGO Framework v3.4.1" >> "$SHELL_RC"
...
echo ""
echo "==========================================="
echo -e "  ${GREEN}BAGO v3.4.1 instalado correctamente${RESET}"
echo "==========================================="
echo ""
